...
#include "../HostApplication/Drone_Interface/Daemon_Interface/controlthread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ControlThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 37, 15)
    ...
    "ControlThread\0key_press_cmd\0\0key_val\0"
    "key_release_cmd\0"
};
...
void ControlThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->key_press_cmd((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->key_release_cmd(); break;
        default: ;
        }
    }
}
...
const QMetaObject ControlThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ControlThread.data,
      qt_meta_data_ControlThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ControlThread.stringdata))
