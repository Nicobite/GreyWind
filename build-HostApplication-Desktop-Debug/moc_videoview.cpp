...
#include "../HostApplication/GUI/videoview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 26, 6)
    ...
    "VideoView\0slotDrawToView\0\0pixmap\0"
};
...
void VideoView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slotDrawToView((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject VideoView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VideoView.data,
      qt_meta_data_VideoView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoView.stringdata))
