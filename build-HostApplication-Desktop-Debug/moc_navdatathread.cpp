...
QT_MOC_LITERAL(4, 39, 2)
    ...
    "NavdataThread\0sendCurrentND\0\0navdata_t\0"
    "nd\0"
};
...
void NavdataThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NavdataThread *_t = static_cast<NavdataThread *>(_o);
        switch (_id) {
        case 0: _t->sendCurrentND((*reinterpret_cast< navdata_t(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (NavdataThread::*_t)(navdata_t );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NavdataThread::sendCurrentND)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void NavdataThread::sendCurrentND(navdata_t _t1)
{
