...
#include "../HostApplication/Threads/videothread.hpp"
...
QT_MOC_LITERAL(7, 68, 3)
    ...
    "VideoThread\0sigFrameToGUI\0\0image\0"
    "displayFrame\0updateSrc\0std::string\0"
    "src\0"
};
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sigFrameToGUI((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 1: _t->displayFrame((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 2: _t->updateSrc((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoThread::sigFrameToGUI)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void VideoThread::sigFrameToGUI(QImage _t1)
{
