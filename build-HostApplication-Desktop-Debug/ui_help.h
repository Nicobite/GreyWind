...
public:
    ...
    void setupUi(QDialog *Help)
    {
        ...
        a->setPixmap(QPixmap(QString::fromUtf8("../../../Desktop/Link to GreyWind/HostApplication/ressources/keys/arrows.png")));
        a->setScaledContents(true);
        s = new QLabel(groupBox);
        s->setObjectName(QStringLiteral("s"));
        s->setGeometry(QRect(70, 40, 44, 40));
        s->setPixmap(QPixmap(QString::fromUtf8("../../../Desktop/Link to GreyWind/HostApplication/ressources/keys/s.png")));
        s->setScaledContents(true);
        q = new QLabel(groupBox);
        q->setObjectName(QStringLiteral("q"));
        q->setGeometry(QRect(20, 100, 44, 40));
        q->setPixmap(QPixmap(QString::fromUtf8("../../../Desktop/Link to GreyWind/HostApplication/ressources/keys/q.png")));
        q->setScaledContents(true);
        d = new QLabel(groupBox);
        d->setObjectName(QStringLiteral("d"));
        d->setGeometry(QRect(70, 100, 44, 40));
        d->setPixmap(QPixmap(QString::fromUtf8("../../../Desktop/Link to GreyWind/HostApplication/ressources/keys/d.png")));
        d->setScaledContents(true);
        z = new QLabel(groupBox);
        z->setObjectName(QStringLiteral("z"));
        z->setGeometry(QRect(20, 40, 44, 40));
        z->setPixmap(QPixmap(QString::fromUtf8("../../../Desktop/Link to GreyWind/HostApplication/ressources/keys/z.png")));
        ...
        f->setPixmap(QPixmap(QString::fromUtf8("../../../Desktop/Link to GreyWind/HostApplication/ressources/keys/f.png")));
