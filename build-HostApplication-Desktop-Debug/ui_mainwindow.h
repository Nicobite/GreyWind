...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("../../../Desktop/Link to GreyWind/HostApplication/ressources/system-software-update.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral("../../../Desktop/Link to GreyWind/HostApplication/ressources/Help-icon.png"), QSize(), QIcon::Normal, QIcon::Off);
